            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-4-5">
                    <div class="shop-product-fillter">
                      ...
                      <div style="text-align: center;"><h3>정말로 탈퇴하시겠어요?</h3></div><br>
                      <div>    </div>
                      <div style="text-align: center;">비밀번호를 입력하고 확인을 누르시면 탈퇴가 진행됩니다.</div> <br>
                    
 <form  style="width: 30%;margin: 0 auto;" action="<%=request.getContextPath() %>/delete.do" method="post" >
      ...
      <div></div><br>
          <div id="errMsg" style="color:red;text-align: center;"><br><%=errMsg %></div>
