...
public interface IPostDAO {
	 ...
	 * @return 작업성공 : 1, 작업실패 : 0
	 */
	public int deletePost(SqlMapClient smc, int postingNo);
...
//	public List<qnaVO> searchQnaList(SqlMapClient smc, qnaVO qv);
//	
//	public List<qnaVO> searchQna(SqlMapClient smc, qnaVO qv);
}
