 ...
 */
@WebServlet("/moreQna.do")
public class moreQnaController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 2. qna 조회
		List<qnaVO> moreQna = qnaService.moreQna(lecId);
				
		req.setAttribute("moreQna", moreQna);
		req.setAttribute("lv", lv);
				
		RequestDispatcher rd =  
			req.getRequestDispatcher("/WEB-INF/jsp/qna/moreQnaList.jsp");
		rd.forward(req, resp);
		}
