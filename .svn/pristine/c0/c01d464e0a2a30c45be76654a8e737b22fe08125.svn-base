 ...
 */
@WebServlet("/deleteMoreQna.do")
public class deleteMoreQnaController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String redirectUrl = request.getContextPath() +  "/moreQna.do?qnaNo=" + qnaNo + "&lecId=" + lecId;
