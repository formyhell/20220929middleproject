					...
					<article class="itemlist">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-2 col-sm-2 col-4 col-action text-end">
                                    <a href="<%=request.getContextPath()%>/lecture/update.do?lecId=<%=lecList.get(i).getLecId() %>" class="btn btn-sm font-sm rounded btn-brand"> <i class="material-icons md-edit"></i> 정보수정 </a>
                                    <a href="<%=request.getContextPath()%>/lecture/delete.do?lecId=<%=lecList.get(i).getLecId() %>" class="btn btn-sm font-sm btn-light rounded"> <i class="material-icons md-delete_forever"></i> 삭제 </a>
                                </div>
                            </div>
                            <!-- row .// -->
                        </article>
