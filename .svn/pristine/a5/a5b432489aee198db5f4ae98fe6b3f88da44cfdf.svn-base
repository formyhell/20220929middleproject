        ...
        <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <p class="font-sm mb-0">&copy; 2022, <strong class="text-brand">_DING</strong> - 개인정보취급방침 및 이용약관 <br />All rights reserved</p>
                    <a href="<%=request.getContextPath()%>/adminLoginView.do">ADMIN</a>
                </div>
                <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                    <div class="hotline d-lg-inline-flex mr-30">
                        <img src="<%=request.getContextPath()%>/nest-frontend/assets/imgs/theme/icons/phone-call.svg" alt="hotline" />
                        <p>7386 - 0219<span>Working 9:00 - 17:30</span></p>
                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                    ...
                    <p class="font-sm">Subscribe to access more content!</p>
                </div>
            </div>
        </div>
    </footer>
